...
// $total_pages_sqls = "SELECT COUNT(*) FROM other";
//         $results = mysqli_query($conn,$total_pages_sqls);
//         $total_rows = mysqli_fetch_array($results)[0];
//         $total_pages = ceil($total_rows / $no_of_records_per_page);

//         $sql = "SELECT * FROM other where rollno= $rn LIMIT $offset, $no_of_records_per_page";
//         $results = mysqli_query($conn,$sql);
  ?>
...
echo "</td><td><a href='my_other.php?deloa=$fn'  onClick=\"return confirm('Are you sure you want to delete this ?');\" ><button type='submit' name='delete' class='del-btn'><i class='fa fa-trash'></i></button></a></td></tr>";
